...
1. Begin with a whole-project scan (e.g., dependency mapping and architecture read-through) to clarify structure and pain points.
2. Tackle fixes module by module, addressing prioritized issues in each area.
3. Finish with integrated verification of the end-to-end experience (e.g., smoke tests or guided walkthroughs).
